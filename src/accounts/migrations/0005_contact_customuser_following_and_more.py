# Generated by Django 4.2 on 2023-07-20 11:46
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0004_alter_customuser_custom_id'),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='contact',
            index=models.Index(fields=['-date_created'], name='accounts_co_date_cr_93cede_idx'),
        ),
    ]
